...
class SmileApp(QApplication):
    ...
    def _setup_camera_worker(self):
        ...
        self.camera_worker.frame_ready.connect(self.face_worker.update_frame)
    ...
    def _create_workers(self):
        ...
        self.face_worker = FaceRecognitionWorker(SmileApp._FACE_MODEL_PATH)
        self.smile_worker = SmileRecognitionWorker(SmileApp._LANDMARKER_MODEL_PATH)

        self.threads: tuple[QThread, ...] = (
            SmileApp._create_working_thread(self.camera_worker, "camera_worker"),
            SmileApp._create_working_thread(self.face_worker, "face_worker"),
            SmileApp._create_working_thread(self.smile_worker, "smile_worker"),
        )
